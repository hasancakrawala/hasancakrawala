# Design Brief — Hasan's Strategic Portfolio

> Original content generation prompt used to build this site in [Lovable](https://lovable.dev). Kept here as the source of truth for design intent, copy, and section content — see the root [README.md](../README.md) for setup, build, and deployment instructions.
